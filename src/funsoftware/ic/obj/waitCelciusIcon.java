...
/**
 * This icon waits until the temperature sensor reads a value less than or greater than a specified value.
 * @author Thomas Legowo
 */
public class waitCelciusIcon extends objectIcon{
    ...
    // for algorithm representation, represent a wait temperature celcius sensor icon with an identifier of 19
    private int identifier;  
    
    /** Creates a new instance of waitCelciusIcon */
    public waitCelciusIcon() {
    }
     ...
     */
    public waitCelciusIcon(String filepath)
    {
        super(filepath);
    ...
    protected void paintComponent(java.awt.Graphics g)
    {
        ...
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/wait/celcius/celciusField.gif"));
    ...
    /**
     * To set the temperature value attribute of this icon
     * @param var Temperature variable
     */
    ...
    public void setImage()
    {
        ...
        // add le stuffs into le jp
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/wait/celcius/top_left.gif"));
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/wait/celcius/comp"+type+".gif"));
        pic = new PicButton(nic);
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    public void changeComparator(java.awt.event.MouseEvent evt)
    {
        if(evt.getButton() != 3)  // not a right click
        {
            ...
            jp.remove(1);
            // displays the comparator according to its type
            javax.swing.ImageIcon nic = new javax.swing.ImageIcon(getClass().getResource("/icons/wait/celcius/comp"+type+".gif"));
    ...
    /**
     * To stop edit mode for port text field of this wait icon
     */
    ...
    /**
     * Get the help title of this wait celcius sensor icon
     * @return Help title
     */
    public String getHelpTitle()
    {
        String s = "Wait Celcius Sensor Icon";
        return s;
    }
    
    /**
     * Get help message of this wait celcius sensor icon
     * @return Help message
     */    
    ...
    {
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/helps/waitCelciusIcon.gif"));
        return ii;
    }
     ...
     */
    public waitCelciusIcon Clone()
    {
        return new waitCelciusIcon("/icons/wait/celcius/wait_celcius.gif");
    }
