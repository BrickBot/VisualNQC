...
/**
 * This icon waits until the timer reads a value less than or greater than a specified value.
 * @author Thomas Legowo
 */
public class waitTimerIcon extends objectIcon{
    
    // the local variables    
    private int timer_number;   // with default value being 0, timer number can be 0 to 3 (4 timers in the RCX bot)
    private int timer_value;    // default value being 100, minimum is 1, unit is in 10ms.
    private variable var_timer_value;  // alternative to timer_value
    
    private int type;   // originally typed 1, greater than
    
    // for algorithm representation, represent a wait timer icon with an identifier of 21
    private int identifier;   
    
    /** Creates a new instance of waitTimerIcon */
    public waitTimerIcon() {
    }
     ...
     */
    public waitTimerIcon(String filepath)
    {
        super(filepath);
    ...
    protected void paintComponent(java.awt.Graphics g)
    {
        ...
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/wait/timer/timerField.gif"));
    ...
    /**
     * Return the light sensor value threshold of this wait timer icon
     * @return Timer value
     */
    ...
    /**
     * Set the timer value of this icon
     * @param var The new timer value variable
     */
    ...
    public void setImage()
    {
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/wait/timer/top_left.gif"));
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/wait/timer/comp"+type+".gif"));
        pic = new PicButton(nic);
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    public void changeComparator(java.awt.event.MouseEvent evt)
    {
        if(evt.getButton() != 3)  // not a right click
        {
            ...
            jp.remove(1);
            // displays the comparator according to its type
            javax.swing.ImageIcon nic = new javax.swing.ImageIcon(getClass().getResource("/icons/wait/timer/comp"+type+".gif"));
    ...
    /**
     * Stop the edit mode of the timer number on this wait icon
     */
    ...
    /**
     * Stop the edit mode of the timer value on this wait icon
     */
    ...
    /**
     * Get the help title of this wait timer icon
     * @return Help title
     */
    public String getHelpTitle()
    {
        String s = "Wait Timer Sensor Icon";
        return s;
    }
    
    /**
     * Get help message of this wait timer icon
     * @return Help message
     */    
    ...
    {
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/helps/waitTimerIcon.gif"));
        return ii;
    }
     ...
     */
    public waitTimerIcon Clone()
    {
        return new waitTimerIcon("/icons/wait/timer/wait_timer.gif");
    }
    ...
    public String getNQCCode(String indentation)
    {
        ...
        NQCCode += "// wait timer\n";
        NQCCode += indentation;
        NQCCode += "until(Timer("+timer_number+") ";
