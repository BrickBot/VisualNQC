 ...
 * beginTaskIcon.java
 *
 * Created on 30 December 2005, 16:40
 *
 */
...
/**
 * This class represents an icon that indicates a task is to be called in and started.
 * @author Thomas Legowo 
 */
public class beginTaskIcon extends objectIcon{
    
    // private variables
    private int num_id;    // id of the task to be started as given by the TaskWindow class        
    private String name;   // name of this task as given by the user
    // for algorithm representation, represent a beginTask icon with an identifier of 10
    private int identifier;
    
    // the task this icon is starting
    private task the_task;
    
    /** Creates a new instance of beginTaskIcon */
    public beginTaskIcon() {
    }
    
    /**
     * Creates a new instance of beginTaskIcon
     * @param filepath The filepath of this icon's image
     */
    public beginTaskIcon(String filepath) {
        super(filepath);
    ...
    protected void paintComponent(java.awt.Graphics g)
    {
        ...
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/task/start/nameField.gif"));
   ...
   /**
     ...
     * @return The task this icon is connected to
     */
    public task getTask()
    {
        return the_task;
   ...
   /**
    ...
    public void setImage()
    {
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/task/start/startleft.gif"));
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/task/start/starttop.gif"));
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/task/start/startbottom.gif"));
        pic = new PicButton(nic);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/task/start/startright.gif"));
        pic = new PicButton(nic);
        gridBagConstraints = new java.awt.GridBagConstraints();
     ...
     */
    public beginTaskIcon Clone()
    {
        return new beginTaskIcon("/icons/task/start/startTask.gif");
    }
    ...
    /**
     * Get the help title of this start task icon
     * @return Help title
     */
    public String getHelpTitle()
    {
        String s = "Start Task Icon";
        return s;
    }
    
    /**
     * Get help message of this start task icon
     * @return Help message
     */     
    ...
    {
        String s = "This icon starts a specified task.";
        return s;
    }
    ...
    {
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/helps/beginTaskIcon.gif"));
        return ii;
    }
    ...
    public String getNQCCode(String indentation)
    {
        ...
        NQCCode += indentation+"// Start a task \n";
        NQCCode += indentation+"start ";
        java.util.Vector<auxiliary> al = aux_list.Instance().getAuxiliaries();        
