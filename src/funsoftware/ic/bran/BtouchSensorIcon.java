/*
 * BtouchSensorIcon.java
 *
 * Created on 3 August 2005, 21:11
 */
...
/**
 * This class is for the Branch Touch Sensor Icon of the fUNSoftWare
 * @author Thomas Legowo
 * 
 */
public class BtouchSensorIcon extends branchIcon{
          
    private int port;   // with default value being 1, port is the value of the input port of this touch sensor
    
    // for algorithm representation, represent a branch touch sensor icon with an identifier of 1
    private int identifier;
    
    private int type;   // originally typed 1, "Y" for sensor touched
    
    /** Creates a new instance of BtouchSensorIcon */
    public BtouchSensorIcon() {
    }
    
    /**
     * Creates a new instance of BtouchSensorIcon
     * @param filepath The source file of the BtouchSensorIcon icon
     */
    public BtouchSensorIcon(String filepath)
    {
        super(filepath);
    ...
    public void setImage()
    {
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/branches/touch/touch_if_top.gif"));
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/branches/touch/comp"+type+".gif"));
    ...
    public void changeComparator(java.awt.event.MouseEvent evt)
    {
        if(evt.getButton() != 3)  // not a right click
        {
            ...
            {
                type = 1;
                nic = new javax.swing.ImageIcon(getClass().getResource("/icons/branches/touch/comp1.gif"));
            }
            else if(type == 1)
            {
                type = 2;
                nic = new javax.swing.ImageIcon(getClass().getResource("/icons/branches/touch/comp2.gif"));
            } 
    ...
    /**
     * Get the help title of this branch touch sensor icon
     * @return Help title
     */
    public String getHelpTitle()
    {
        String s = "Branch Touch Sensor Icon";
        return s;
    }
    
    /**
     * Get help message of this branch touch sensor icon
     * @return Help message
     */    
    ...
    {
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/helps/BtouchSensorIcon.gif"));
        return ii;
    }
     ...
     */
    public BtouchSensorIcon Clone()
    {
        return new BtouchSensorIcon("/icons/branches/touch/icon_if.gif");
    }
    ...
    public String getNQCCode(String indentation)
    {
        ...
        NQCCode += indentation;
        NQCCode += "// touch sensor test(branch) \n";
