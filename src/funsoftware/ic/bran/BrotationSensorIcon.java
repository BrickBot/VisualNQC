/*
 * BrotationSensorIcon.java
 *
 * Created on 24 September 2005, 11:55
 *
 */
...
/**
 * This class is for the Branch Rotational Sensor Icon of the fUNSoftWare
 * @author Thomas Legowo
 */
public class BrotationSensorIcon extends branchIcon{
    ...
    // for algorithm representation, represent this branch rotation sensor icon with an identifier of 4
    ...
    /**
     * Creates a new instance of BrotationSensorIcon
     * @param filepath Source file for this icon
     */
    public BrotationSensorIcon(String filepath)
    {
        super(filepath);
    ...
    protected void paintComponent(java.awt.Graphics g)
    {
        ...
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/branches/rotation/rotation_field.gif"));
        g.drawImage(ii.getImage(), 14, 24, this);
    }     
    
    // return the port this rotation sensor is operating in
    /**
    ...
    /**
     * To set the prot value of this icon
    ...
    public void setImage()
    {
        ...
        nic = new javax.swing.ImageIcon(getClass().getResource("/icons/branches/rotation/rotationtop.gif"));
    ...
    // to change the angle value comparator
    
    /**
     * To change the angular value of this branch rotational sensor icon
     * @param evt Mouse event
     */
    ...
    // this method is to stop the edit mode of the port value on this branch icon
    /**
    ...
    /**
     * this method is to stop the edit mode of the angle value on this branch icon
     */
    ...
    /**
     * Get the help title of this branch rotational sensor icon
     * @return Help title
     */
    public String getHelpTitle()
    {
        String s = "Branch Rotational Sensor Icon";
        return s;
    }
    
    /**
     * Get help message of this branch rotational sensor icon
     * @return Help message
     */
    ...
    public String getHelpDesc()
    {
        String s = "This icon acts as a branch.\nIt chooses one between two paths\ndepending on whether the reading from the\n" +
                   "rotation sensor value is greater or less than\nand equal to the specified value. The rotation\nsensor value is in a sixteenths of a rotation.";
        return s;
    }
    ...
    {
        javax.swing.ImageIcon ii = new javax.swing.ImageIcon(getClass().getResource("/icons/helps/BrotationSensorIcon.gif"));
        return ii;
    }
     ...
     */
    public BrotationSensorIcon Clone()
    {
        return new BrotationSensorIcon("/icons/branches/rotation/rotation.gif");
    }
    ...
    public Icon Copy()
    {
        BrotationSensorIcon newWTI = Clone();
        newWTI.setPort(port);
        if(var_angle_value != null)
        {
    ...
    public String getNQCCode(String indentation)
    {
        ...
        NQCCode += indentation;
        NQCCode += "// rotational sensor test(branch) \n";
